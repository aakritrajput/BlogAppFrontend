...
function CreateBlog() {
  ...
  return (
    <div className='max-w-[100vw] min-h-[100vh] relative bg-[#DDDBDB] p-4 px-[5vw]'>
      {loading && 
      ...
      <form onSubmit={handleSubmit(submitHandler)}  encType="multipart/form-data">
        ...
        <div className='flex gap-2 mt-[20px]  items-center w-full'>
            ...
            <input type="file" id="coverImage" className='bg-[#9d9a9a] flex-1 py-3 focus:outline-[#207F87] p-2 rounded-lg focus:bg-[#bdbbbb]' {...register("coverImage", {required: "Cover-photo is required !!"})} />
        </div>
